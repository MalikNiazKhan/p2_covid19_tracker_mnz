      ...
      <Grid container spacing={3} justify="center">
        ...
        <Grid item component={Card} xs={12} md={3} className={cx(styles.card, styles.infected)}>
          <CardContent>
            ...
            <Typography varaint="dody2">Number of active cases of COVID-19</Typography>
          </CardContent>
        </Grid>
        ...
        <Grid item component={Card} xs={12} md={3} className={cx(styles.card, styles.recovered)}>
          <CardContent>
            ...
            <Typography color="textSecondary">{new Date(lastUpdate).toDateString()}</Typography>
            <Typography varaint="dody2">Number of recovered cases of COVID-19</Typography>
          </CardContent>
        </Grid>
        ...
        <Grid item component={Card} xs={12} md={3} className={cx(styles.card, styles.deaths)}>
          <CardContent>
            ...
            <Typography color="textSecondary">{new Date(lastUpdate).toDateString()}</Typography>
            <Typography varaint="dody2">Number of deaths cases of COVID-19</Typography>
          </CardContent>
        </Grid>
